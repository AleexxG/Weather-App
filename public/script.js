...
else if (icon === "http://openweathermap.org/img/wn/02d@2x.png" || icon === "http://openweathermap.org/img/wn/03d@2x.png") {
    bgImg.style.backgroundImage = "url('./img/fewCloudsD.jpg')"
}
else if (icon === "http://openweathermap.org/img/wn/02n@2x.png" || icon === "http://openweathermap.org/img/wn/03n@2x.png") {
...
else if (icon === "http://openweathermap.org/img/wn/09d@2x.png" || icon === "http://openweathermap.org/img/wn/10d@2x.png") {
    bgImg.style.backgroundImage = "url('./img/rainD.jpg')"
}
else if (icon === "http://openweathermap.org/img/wn/09n@2x.png" || icon === "http://openweathermap.org/img/wn/10n@2x.png") {
...
else if (icon === "http://openweathermap.org/img/wn/13d@2x.png" || icon === "http://openweathermap.org/img/wn/13n@2x.png") {
